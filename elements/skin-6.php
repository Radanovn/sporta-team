<div class="row no-gutters edit safe-mode allow-drop" field="layout-news-inner-skin-6" rel="global">
    <div class="col-lg-8 col-xl-6 mx-auto">
        ...
        <div class="wrap-link">
            <div class="wrap-link">
                <module type="btn" class="allow-drop"  template="sporta-card-links-with-icons" button_style="red text-decoration-none font-weight-bold" button_text="<?php echo $read_more_text;?>">
            </div>
        </div>
