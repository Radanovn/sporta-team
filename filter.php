                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-0 bg-transparent color-red rounded-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">The Sport-i-Label is a quality label that Sporta uses to reward and reward sports clubs that have a thriving youth operation or want to in-vest in it. Depending on the content of their file, sports clubs score a gold, silver or bronze label.</p>
                                </div>
                                ...
                                <ul class="pagination border-0 rounded-0 justify-content-center">
                                        ...
                                        <a class="page-link" href="#" aria-label="Previous">
                                            <span aria-hidden="true">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="5" height="8" viewBox="0 0 5 8" fill="none">
                                                    <path d="M4.33398 1.15942L1.33398 4.15942L4.33398 7.15942" stroke="#1D2128" stroke-linecap="round" stroke-linejoin="round"/>
                                                </svg>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="page-item">
                                        <a class="page-link" href="#" aria-label="Next">
                                            <span aria-hidden="true">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="5" height="8" viewBox="0 0 5 8" fill="none">
                                                    <path d="M1.25 7.02271L4.25 4L1.25 0.977295" stroke="#1D2128" stroke-linecap="round" stroke-linejoin="round"/>
                                                </svg>
                                            </span>
                                        </a>
                                    </li>
