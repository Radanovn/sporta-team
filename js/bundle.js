...
/***/ "./src/assets/js/calendar-filters.js":
/*!*******************************************!*\
  !*** ./src/assets/js/calendar-filters.js ***!
  \*******************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  ...
  $('#form-filters input[type="checkbox"].js-filter').on('click', function () {
    var filtersSpan = filtersSelected.find('.filter-picked');
...
$(document).on('click', '.js-filter-picked.clear-all', function () {
  var checkboxChecked = $('#form-filters input[type="checkbox"].js-filter:checked');
...
$(document).on('click', '.js-filter-picked', function () {
  ...
  var filtersSpan = $('.filters-selected').find('.js-filter-picked');
...
/* WEBPACK VAR INJECTION */(function($) {$.fn.datepicker.language['en'] = {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var slick_carousel_slick_slick_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! slick-carousel/slick/slick.min */ "./node_modules/slick-carousel/slick/slick.min.js");
...
/* harmony import */ var youtube_iframe_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! youtube-iframe/index */ "./node_modules/youtube-iframe/index.js");
/* harmony import */ var youtube_iframe_index__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(youtube_iframe_index__WEBPACK_IMPORTED_MODULE_1__);
...
$(document).ready(function () {
  ...
  $('.nice-select .list').each(function H(i, elem) {
    new simplebar__WEBPACK_IMPORTED_MODULE_0__["default"](elem, {
      autoHide: false
    });
  });
  ...
  $('.js-video-play').on('click', function () {
    ...
    var id_youtube = $(this).parents('.video-wrap').find('.js-video-player').attr('data-youtube-id'),
        id_player = $(this).parents('.video-wrap').find('.js-video-player').attr('id');
    $(this).parents('.video-wrap').css('height', 'auto');
    youtube_iframe_index__WEBPACK_IMPORTED_MODULE_1___default.a.load(function (YT) {
...
$(document).ready(function () {
  ...
  $('.js-mobile-menu').on('click', function (e) {
    $('body').toggleClass('mobile-menu-open'); // $('.header-top').toggleClass('mobile-menu-open');

    $('.header').toggleClass('mobile-menu-open');
  });
  $('.js-tablet-menu').on('click', function (e) {
    $('body').toggleClass('tablet-menu-open'); // $('.header-top').toggleClass('mobile-menu-open');
...
/***/ "./src/assets/lib/js/devLogger.js":
/*!****************************************!*\
  !*** ./src/assets/lib/js/devLogger.js ***!
  \****************************************/
/*! exports provided: isDev, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var DevLogger = /*#__PURE__*/function () {
  ...
  _createClass(DevLogger, [{
    key: "logInProduction",
    value: function logInProduction() {
      var _console;

      if (!isDev) (_console = console).log.apply(_console, arguments);
    }
  }, {
    key: "notify",
    value: function notify() {
      this.log.apply(this, ["%cNotify", "".concat(this.style, "background: ").concat(this.colors.notify, ";")].concat(Array.prototype.slice.call(arguments)));
    }
  }, {
    key: "warning",
    value: function warning() {
      this.log.apply(this, ["%cWarning", "".concat(this.style, "background-color: ").concat(this.colors.warning, ";")].concat(Array.prototype.slice.call(arguments)));
    }
  }, {
    key: "error",
    value: function error() {
      this.log.apply(this, ["%cError", "".concat(this.style, "background-color: ").concat(this.colors.error, ";")].concat(Array.prototype.slice.call(arguments)));
    }
  }, {
    key: "handler",
    ...
    value: function log() {
      ...
      if (isDev) (_console2 = console).log.apply(_console2, arguments);
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (new DevLogger());
...
/* harmony import */ var lib_js_devLogger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lib/js/devLogger */ "./src/assets/lib/js/devLogger.js");
...
/* harmony import */ var jquery_nice_select__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! jquery-nice-select */ "./node_modules/jquery-nice-select/js/jquery.nice-select.min.js");
/* harmony import */ var jquery_nice_select__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(jquery_nice_select__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var air_datepicker_dist_js_datepicker_min__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! air-datepicker/dist/js/datepicker.min */ "./node_modules/air-datepicker/dist/js/datepicker.min.js");
/* harmony import */ var air_datepicker_dist_js_datepicker_min__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(air_datepicker_dist_js_datepicker_min__WEBPACK_IMPORTED_MODULE_5__);
// import styles
 //import global libs
...
window.dl = lib_js_devLogger__WEBPACK_IMPORTED_MODULE_1__["default"];
window.$ = jquery__WEBPACK_IMPORTED_MODULE_2___default.a; // import global constants

 // set global constants

Object.defineProperty(window, 'isDev', {
  value: lib_js_devLogger__WEBPACK_IMPORTED_MODULE_1__["isDev"]
}); // require main js file

__webpack_require__(/*! js/index */ "./src/assets/js/index.js");

__webpack_require__(/*! js/form-validation */ "./src/assets/js/form-validation.js");

__webpack_require__(/*! js/datepicker */ "./src/assets/js/datepicker.js");

__webpack_require__(/*! js/calendar-filters */ "./src/assets/js/calendar-filters.js");

__webpack_require__(/*! js/gallery */ "./src/assets/js/gallery.js");
