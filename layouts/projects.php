...
<div class="edit main-content" rel="content" field="sporta-team_projects">
        ...
        <div class="row no-gutters">
            <div class="col-md-4 order-1 hero__content">
                ...
                <div class="hero__wrap-btn">
                    <a href="#" class="btn btn-red btn-animate">GTA</a>
                </div>
            </div>
            <div class="col-md-8 order-0 order-md-1 hero__img">
                <picture>
                    <source srcset="<?php print template_url(); ?>images/projects-hero-img-mobile.jpg" media="(max-width: 767px)">
            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    <div class="section__block-title text-sm-center">
                        ...
                        <p class="lead-text">.... has been allowing young people to multisport from childhood. From the medical world, the call for multi&#8209;faceted sports practice for young children is getting louder. This is based on numerous scientific studies that show that practicing a single sport involves a signifi-cantly greater risk of stress fractures and other overuse injuries. Children who move too unilaterally also develop less motor skills.</p>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <section class="section-fullwidth-img section-projects-info">
        <div class="wrap-img">
            <picture>
                <source srcset="<?php print template_url(); ?>images/volleyball-projects-mobile.jpg" media="(max-width: 991px)">
        ...
        <div class="container position-relative">
            <div class="card-info text-center">
                ...
                <a href="#" class="btn btn-animate btn-small">MEER INFO</a>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-6 order-0 order-lg-1">
                    <div class="about-card__img about-card__img--ml">
                        ...
                        <picture>
                            ...
                            <source srcset="<?php print template_url(); ?>images/projects-img-1-tablet.jpg" media="(min-width: 480px) and (max-width: 991px)">
                ...
                <div class="col-lg-6">
                    <div class="about-card__img">
                        ...
                        <picture>
                            ...
                            <source srcset="<?php print template_url(); ?>images/projects-about-img-2-tablet.jpg" media="(min-width: 480px) and (max-width: 991px)">
