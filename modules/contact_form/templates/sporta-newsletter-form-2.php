 ...
 */
?>
<form class="form-newsletter needs-validation edit" field="contact-form-newsletter" rel="global" data-form-id="<?php print $form_id ?>" name="<?php print $form_id ?>" method="post" novalidate>
    <?php print csrf_form() ?>
