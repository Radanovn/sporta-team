...
?>
<section class="section section-about section-custom-accompaniment edit safe-mode allow-drop" field="layout-club-vizit-skin-2-<?php print $params['id'] ?>" rel="content">
