...
?>
<section class="section section-filter section-multimove-advantages edit safe-mode allow-drop" field="layout-multimove-skin-3-<?php print $params['id'] ?>" rel="content">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card border-0 bg-transparent color-red rounded-0">
                    ...
                    <div class="card-footer border-0 bg-transparent rounded-0">
                        <module type="btn" class="allow-drop"  template="sporta-card-links-with-icons" button_style="red" button_text="Meer info">
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card border-0 bg-transparent color-green">
                    ...
                    <div class="card-footer border-0 bg-transparent">
                        <module type="btn" class="allow-drop"  template="sporta-card-links-with-icons" button_style="green" button_text="Meer info">
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card border-0 bg-transparent color-yellow">
                    ...
                    <div class="card-footer border-0 bg-transparent">
                        <module type="btn" class="allow-drop"  template="sporta-card-links-with-icons" button_style="yellow" button_text="Meer info">
                    </div>
                </div>
            </div>
        </div>
