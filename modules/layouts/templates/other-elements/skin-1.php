...
?>
<section class="section section-reasons bg-gray edit safe-mode allow-drop" field="layout-other-elements-skin-1-<?php print $params['id'] ?>" rel="content">
    <div class="container">
        <div class="row">
