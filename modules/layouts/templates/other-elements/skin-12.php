...
?>
<section class="section section-contact-person section-contact-person-other edit safe-mode nodrop" field="layout-other-elements-skin-12-<?php print $params['id'] ?>" rel="content">
    <div class="container">
        <div class="row">
