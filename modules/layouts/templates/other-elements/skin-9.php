...
?>
<section class="section section-contact section-contact-other edit safe-mode allow-drop" field="layout-other-elements-skin-9-<?php print $params['id'] ?>" rel="content">
    <div class="container">
