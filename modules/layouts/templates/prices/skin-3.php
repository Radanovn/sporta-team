                    ...
                    <div class="st-table-body">
                        <div class="st-table-row cloneable">
                            <div class="st-table-cell st-table-cell--category">
                                <div class="cell-category-centered">
                                    <p class="sporta-prices-table-paragraph">CATEGORIE</p>
                                    <h4 class="text-red">A</h4>
                                </div>
                            </div>
                            <div class="st-table-cell st-table-cell--branch">
                                <div class="st-table-cell__content st-table-cell__content-centered">
                                    <p class="sporta-prices-table-title">SPORTTAKKEN</p>
                            ...
                            <div class="st-table-cell st-table-cell--price">
                                <div class="cell-price-centered">
                                    <p class="sporta-prices-table-price">TARIEF PER LID/JAAR</p>
                                    <h4>€ 11,00</h4>
                                </div>
                            </div>
