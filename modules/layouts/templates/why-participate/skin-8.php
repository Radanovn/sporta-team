...
?>
<section class="section section-about section-participate-about edit safe-mode allow-drop" field="layout-why-participate-skin-8-<?php print $params['id'] ?>" rel="content">
    <div class="container">
