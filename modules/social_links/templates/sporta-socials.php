...
<ul class="list-inline no-style mb-0">
    ...
    <?php if ($twitter_enabled) { ?>
        <li class="mx-1"><a href="//twitter.com/<?php print $twitter_url; ?>" target="_blank" class="text-primary"><i class="mdi mdi-twitter mdi-24px"></i></a></li>
    <?php } ?>
    ...
    <?php if ($linkedin_enabled) { ?>
        <li class="mx-1"><a href="//linkedin.com/<?php print $linkedin_url; ?>" target="_blank" class="text-primary"><i class="mdi mdi-linkedin mdi-24px"></i></a></li>
    <?php } ?>
